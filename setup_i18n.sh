...
python3 -c "import mkdocs_static_i18n; print('✅ mkdocs-static-i18n 安装成功')" 2>/dev/null || echo "❌ mkdocs-static-i18n 安装失败"
python3 -c "import mkdocs; print('✅ mkdocs 安装成功')" 2>/dev/null || echo "❌ mkdocs 安装失败"
